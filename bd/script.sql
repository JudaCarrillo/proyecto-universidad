...
CREATE TABLE CronogramaPagos (
    idCronogramaPagos INT IDENTITY PRIMARY KEY ,
    idCarrera INT,
	Costo DECIMAL,
...
-- Tabla SAA
CREATE TABLE SAA (
    idSAA INT IDENTITY PRIMARY KEY ,
    idAlumno INT,
    FOREIGN KEY (idAlumno) REFERENCES Alumnos(idAlumno)
);
...
CREATE TABLE PlataformaExterna (
    idPlataformaExterna INT IDENTITY PRIMARY KEY ,
    idAlumno INT,
    FOREIGN KEY (idAlumno) REFERENCES Alumnos(idAlumno)
);
...
-- Tabla Notas
CREATE TABLE Notas (
    idNotas INT IDENTITY PRIMARY KEY ,
    idMateria INT,
    idAlumno INT,
    nota DECIMAL(4, 2),
    FOREIGN KEY (idMateria) REFERENCES Materia(idMateria),
...
INSERT INTO Profesor (nombre,correo,contraseña)VALUES ('Walter Coaguila','242424@senati.pe','242424'),('Adrian Gonzales','242425@senati.pe','242425')
